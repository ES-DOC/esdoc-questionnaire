...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MetadataVersion.version'
        db.alter_column(u'questionnaire_metadataversion', 'version', self.gf('django.db.models.fields.CharField')(default='1.0', max_length=256))

    def backwards(self, orm):

        # Changing field 'MetadataVersion.version'
        db.alter_column(u'questionnaire_metadataversion', 'version', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))
