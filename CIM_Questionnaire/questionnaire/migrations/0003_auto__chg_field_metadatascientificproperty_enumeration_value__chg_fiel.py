...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MetadataScientificProperty.enumeration_value'
        db.alter_column(u'questionnaire_metadatascientificproperty', 'enumeration_value', self.gf('CIM_Questionnaire.questionnaire.fields.EnumerationField')(null=True))

        # Changing field 'MetadataStandardPropertyCustomizer.enumeration_default'
        db.alter_column(u'questionnaire_metadatastandardpropertycustomizer', 'enumeration_default', self.gf('CIM_Questionnaire.questionnaire.fields.EnumerationField')(null=True))

        # Changing field 'MetadataStandardPropertyCustomizer.enumeration_choices'
        db.alter_column(u'questionnaire_metadatastandardpropertycustomizer', 'enumeration_choices', self.gf('CIM_Questionnaire.questionnaire.fields.EnumerationField')(null=True))

        # Changing field 'MetadataStandardPropertyCustomizer.relationship_cardinality'
        db.alter_column(u'questionnaire_metadatastandardpropertycustomizer', 'relationship_cardinality', self.gf('CIM_Questionnaire.questionnaire.fields.CardinalityField')(max_length=8))

        # Changing field 'MetadataScientificPropertyCustomizer.enumeration_default'
        db.alter_column(u'questionnaire_metadatascientificpropertycustomizer', 'enumeration_default', self.gf('CIM_Questionnaire.questionnaire.fields.EnumerationField')(null=True))

        # Changing field 'MetadataScientificPropertyCustomizer.enumeration_choices'
        db.alter_column(u'questionnaire_metadatascientificpropertycustomizer', 'enumeration_choices', self.gf('CIM_Questionnaire.questionnaire.fields.EnumerationField')(null=True))

    def backwards(self, orm):

        # Changing field 'MetadataScientificProperty.enumeration_value'
        db.alter_column(u'questionnaire_metadatascientificproperty', 'enumeration_value', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True))

        # Changing field 'MetadataStandardPropertyCustomizer.enumeration_default'
        db.alter_column(u'questionnaire_metadatastandardpropertycustomizer', 'enumeration_default', self.gf('questionnaire.fields.EnumerationField')(null=True))

        # Changing field 'MetadataStandardPropertyCustomizer.enumeration_choices'
        db.alter_column(u'questionnaire_metadatastandardpropertycustomizer', 'enumeration_choices', self.gf('questionnaire.fields.EnumerationField')(null=True))

        # Changing field 'MetadataStandardPropertyCustomizer.relationship_cardinality'
        db.alter_column(u'questionnaire_metadatastandardpropertycustomizer', 'relationship_cardinality', self.gf('questionnaire.fields.CardinalityField')(max_length=8))

        # Changing field 'MetadataScientificPropertyCustomizer.enumeration_default'
        db.alter_column(u'questionnaire_metadatascientificpropertycustomizer', 'enumeration_default', self.gf('questionnaire.fields.EnumerationField')(null=True))

        # Changing field 'MetadataScientificPropertyCustomizer.enumeration_choices'
        db.alter_column(u'questionnaire_metadatascientificpropertycustomizer', 'enumeration_choices', self.gf('questionnaire.fields.EnumerationField')(null=True))
