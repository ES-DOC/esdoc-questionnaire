...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MetadataStandardPropertyProxy.documentation'
        db.alter_column(u'questionnaire_metadatastandardpropertyproxy', 'documentation', self.gf('django.db.models.fields.TextField')(null=True))
        # Adding unique constraint on 'MetadataVocabulary', fields ['guid']
        db.create_unique(u'questionnaire_metadatavocabulary', ['guid'])

        # Adding unique constraint on 'MetadataComponentProxy', fields ['guid']
        db.create_unique(u'questionnaire_metadatacomponentproxy', ['guid'])


        # Changing field 'MetadataScientificPropertyProxy.documentation'
        db.alter_column(u'questionnaire_metadatascientificpropertyproxy', 'documentation', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):
        # Removing unique constraint on 'MetadataComponentProxy', fields ['guid']
        db.delete_unique(u'questionnaire_metadatacomponentproxy', ['guid'])

        # Removing unique constraint on 'MetadataVocabulary', fields ['guid']
        db.delete_unique(u'questionnaire_metadatavocabulary', ['guid'])


        # Changing field 'MetadataStandardPropertyProxy.documentation'
        db.alter_column(u'questionnaire_metadatastandardpropertyproxy', 'documentation', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'MetadataScientificPropertyProxy.documentation'
        db.alter_column(u'questionnaire_metadatascientificpropertyproxy', 'documentation', self.gf('django.db.models.fields.TextField')(default=''))
