...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MetadataModelSerialization'
        db.create_table(u'questionnaire_metadatamodelserialization', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('model', self.gf('django.db.models.fields.related.ForeignKey')(related_name='serializations', to=orm['questionnaire.MetadataModel'])),
        ...
        db.send_create_signal('questionnaire', ['MetadataModelSerialization'])

        # Adding unique constraint on 'MetadataModelSerialization', fields ['name', 'version']
        db.create_unique(u'questionnaire_metadatamodelserialization', ['name', 'version'])

        # Deleting field 'MetadataModel.published'
        db.delete_column(u'questionnaire_metadatamodel', 'published')


    def backwards(self, orm):
        # Removing unique constraint on 'MetadataModelSerialization', fields ['name', 'version']
        db.delete_unique(u'questionnaire_metadatamodelserialization', ['name', 'version'])

        # Deleting model 'MetadataModelSerialization'
        db.delete_table(u'questionnaire_metadatamodelserialization')

        # Adding field 'MetadataModel.published'
        db.add_column(u'questionnaire_metadatamodel', 'published',
