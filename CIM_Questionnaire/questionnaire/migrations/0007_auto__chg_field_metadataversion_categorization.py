...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MetadataVersion.categorization'
        db.alter_column(u'questionnaire_metadataversion', 'categorization_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['questionnaire.MetadataCategorization']))

    def backwards(self, orm):

        # Changing field 'MetadataVersion.categorization'
        db.alter_column(u'questionnaire_metadataversion', 'categorization_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['questionnaire.MetadataCategorization']))
