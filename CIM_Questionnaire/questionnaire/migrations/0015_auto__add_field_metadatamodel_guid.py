...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MetadataModel.guid'
        db.add_column(u'questionnaire_metadatamodel', 'guid',
                      self.gf('django.db.models.fields.CharField')(max_length=128, unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MetadataModel.guid'
        db.delete_column(u'questionnaire_metadatamodel', 'guid')
