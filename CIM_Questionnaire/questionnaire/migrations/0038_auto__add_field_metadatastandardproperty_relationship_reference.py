...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MetadataStandardProperty.relationship_reference'
        db.add_column(u'questionnaire_metadatastandardproperty', 'relationship_reference',
                      self.gf('CIM_Questionnaire.questionnaire.fields.ListField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MetadataStandardProperty.relationship_reference'
        db.delete_column(u'questionnaire_metadatastandardproperty', 'relationship_reference')
    ...
    models = {
        ...
        'questionnaire.metadatastandardproperty': {
            ...
            'relationship_reference': ('CIM_Questionnaire.questionnaire.fields.ListField', [], {'null': 'True', 'blank': 'True'}),
