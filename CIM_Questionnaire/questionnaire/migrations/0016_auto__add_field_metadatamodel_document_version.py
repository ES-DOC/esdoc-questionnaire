...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MetadataModel.document_version'
        db.add_column(u'questionnaire_metadatamodel', 'document_version',
                      self.gf('django.db.models.fields.CharField')(default='0.-1', max_length=128),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MetadataModel.document_version'
        db.delete_column(u'questionnaire_metadatamodel', 'document_version')
    ...
    models = {
        ...
        'questionnaire.metadatamodel': {
            ...
            'document_version': ('django.db.models.fields.CharField', [], {'default': "'0.-1'", 'max_length': '128'}),
            'guid': ('django.db.models.fields.CharField', [], {'max_length': '128', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
