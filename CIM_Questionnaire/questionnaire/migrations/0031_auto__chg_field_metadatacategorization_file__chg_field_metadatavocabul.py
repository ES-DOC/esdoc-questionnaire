...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MetadataCategorization.file'
        db.alter_column(u'questionnaire_metadatacategorization', 'file', self.gf('django.db.models.fields.files.FileField')(max_length=256))

        # Changing field 'MetadataVocabulary.file'
        db.alter_column(u'questionnaire_metadatavocabulary', 'file', self.gf('django.db.models.fields.files.FileField')(max_length=256))

        # Changing field 'MetadataVersion.file'
        db.alter_column(u'questionnaire_metadataversion', 'file', self.gf('django.db.models.fields.files.FileField')(max_length=256))

    def backwards(self, orm):

        # Changing field 'MetadataCategorization.file'
        db.alter_column(u'questionnaire_metadatacategorization', 'file', self.gf('django.db.models.fields.files.FileField')(max_length=100))

        # Changing field 'MetadataVocabulary.file'
        db.alter_column(u'questionnaire_metadatavocabulary', 'file', self.gf('django.db.models.fields.files.FileField')(max_length=100))

        # Changing field 'MetadataVersion.file'
        db.alter_column(u'questionnaire_metadataversion', 'file', self.gf('django.db.models.fields.files.FileField')(max_length=100))
