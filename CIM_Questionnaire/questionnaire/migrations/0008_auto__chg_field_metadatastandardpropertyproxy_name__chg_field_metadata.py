...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MetadataStandardPropertyProxy.name'
        db.alter_column(u'questionnaire_metadatastandardpropertyproxy', 'name', self.gf('django.db.models.fields.CharField')(max_length=1024))

        # Changing field 'MetadataScientificPropertyProxy.name'
        db.alter_column(u'questionnaire_metadatascientificpropertyproxy', 'name', self.gf('django.db.models.fields.CharField')(max_length=1024))

        # Changing field 'MetadataScientificPropertyProxy.values'
        db.alter_column(u'questionnaire_metadatascientificpropertyproxy', 'values', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'MetadataStandardPropertyProxy.name'
        db.alter_column(u'questionnaire_metadatastandardpropertyproxy', 'name', self.gf('django.db.models.fields.CharField')(max_length=512))

        # Changing field 'MetadataScientificPropertyProxy.name'
        db.alter_column(u'questionnaire_metadatascientificpropertyproxy', 'name', self.gf('django.db.models.fields.CharField')(max_length=512))

        # Changing field 'MetadataScientificPropertyProxy.values'
        db.alter_column(u'questionnaire_metadatascientificpropertyproxy', 'values', self.gf('django.db.models.fields.CharField')(max_length=1024))
