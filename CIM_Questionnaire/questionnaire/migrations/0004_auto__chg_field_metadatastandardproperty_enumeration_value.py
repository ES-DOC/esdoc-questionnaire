...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MetadataStandardProperty.enumeration_value'
        db.alter_column(u'questionnaire_metadatastandardproperty', 'enumeration_value', self.gf('CIM_Questionnaire.questionnaire.fields.EnumerationField')(null=True))

    def backwards(self, orm):

        # Changing field 'MetadataStandardProperty.enumeration_value'
        db.alter_column(u'questionnaire_metadatastandardproperty', 'enumeration_value', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True))
