...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'MetadataStandardCategoryCustomizer', fields ['key', 'project', 'proxy', 'model_customizer']
        db.create_unique(u'questionnaire_metadatastandardcategorycustomizer', ['key', 'project_id', 'proxy_id', 'model_customizer_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'MetadataStandardCategoryCustomizer', fields ['key', 'project', 'proxy', 'model_customizer']
        db.delete_unique(u'questionnaire_metadatastandardcategorycustomizer', ['key', 'project_id', 'proxy_id', 'model_customizer_id'])
