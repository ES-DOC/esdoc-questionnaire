...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MetadataStandardPropertyProxy.atomic_type'
        db.alter_column(u'questionnaire_metadatastandardpropertyproxy', 'atomic_type', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))

    def backwards(self, orm):

        # Changing field 'MetadataStandardPropertyProxy.atomic_type'
        db.alter_column(u'questionnaire_metadatastandardpropertyproxy', 'atomic_type', self.gf('django.db.models.fields.CharField')(max_length=64))
