...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MetadataStandardPropertyProxy.stereotype'
        db.add_column(u'questionnaire_metadatastandardpropertyproxy', 'stereotype',
                      self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MetadataStandardPropertyProxy.stereotype'
        db.delete_column(u'questionnaire_metadatastandardpropertyproxy', 'stereotype')
