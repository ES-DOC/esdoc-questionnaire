...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MetadataModelProxy.namespace'
        db.add_column(u'questionnaire_metadatamodelproxy', 'namespace',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MetadataModelProxy.namespace'
        db.delete_column(u'questionnaire_metadatamodelproxy', 'namespace')
