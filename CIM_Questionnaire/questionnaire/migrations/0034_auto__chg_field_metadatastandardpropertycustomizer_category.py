...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MetadataStandardPropertyCustomizer.category'
        db.alter_column(u'questionnaire_metadatastandardpropertycustomizer', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['questionnaire.MetadataStandardCategoryCustomizer']))

    def backwards(self, orm):

        # Changing field 'MetadataStandardPropertyCustomizer.category'
        db.alter_column(u'questionnaire_metadatastandardpropertycustomizer', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['questionnaire.MetadataStandardCategoryCustomizer']))
