...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MetadataStandardPropertyProxy.enumeration_choices'
        db.alter_column(u'questionnaire_metadatastandardpropertyproxy', 'enumeration_choices', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'MetadataStandardPropertyProxy.enumeration_choices'
        db.alter_column(u'questionnaire_metadatastandardpropertyproxy', 'enumeration_choices', self.gf('django.db.models.fields.CharField')(max_length=1024))
