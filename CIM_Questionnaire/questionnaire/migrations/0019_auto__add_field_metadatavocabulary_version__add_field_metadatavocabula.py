...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'MetadataVocabulary', fields ['name']
        db.delete_unique(u'questionnaire_metadatavocabulary', ['name'])

        # Adding field 'MetadataVocabulary.version'
        db.add_column(u'questionnaire_metadatavocabulary', 'version',
                      self.gf('django.db.models.fields.CharField')(default='1', max_length=128),
                      keep_default=False)

        # Adding field 'MetadataVocabulary.url'
        db.add_column(u'questionnaire_metadatavocabulary', 'url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding unique constraint on 'MetadataVocabulary', fields ['name', 'version']
        db.create_unique(u'questionnaire_metadatavocabulary', ['name', 'version'])


    def backwards(self, orm):
        # Removing unique constraint on 'MetadataVocabulary', fields ['name', 'version']
        db.delete_unique(u'questionnaire_metadatavocabulary', ['name', 'version'])

        # Deleting field 'MetadataVocabulary.version'
        db.delete_column(u'questionnaire_metadatavocabulary', 'version')

        # Deleting field 'MetadataVocabulary.url'
        db.delete_column(u'questionnaire_metadatavocabulary', 'url')

        # Adding unique constraint on 'MetadataVocabulary', fields ['name']
        db.create_unique(u'questionnaire_metadatavocabulary', ['name'])
