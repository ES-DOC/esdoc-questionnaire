...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MetadataStandardPropertyCustomizer.default_value'
        db.alter_column(u'questionnaire_metadatastandardpropertycustomizer', 'default_value', self.gf('django.db.models.fields.CharField')(max_length=512, null=True))

        # Changing field 'MetadataStandardPropertyCustomizer.field_type'
        db.alter_column(u'questionnaire_metadatastandardpropertycustomizer', 'field_type', self.gf('django.db.models.fields.CharField')(max_length=128))

        # Changing field 'MetadataStandardPropertyCustomizer.verbose_name'
        db.alter_column(u'questionnaire_metadatastandardpropertycustomizer', 'verbose_name', self.gf('django.db.models.fields.CharField')(max_length=128))

        # Changing field 'MetadataScientificPropertyCustomizer.default_value'
        db.alter_column(u'questionnaire_metadatascientificpropertycustomizer', 'default_value', self.gf('django.db.models.fields.CharField')(max_length=512, null=True))

        # Changing field 'MetadataScientificPropertyCustomizer.field_type'
        db.alter_column(u'questionnaire_metadatascientificpropertycustomizer', 'field_type', self.gf('django.db.models.fields.CharField')(max_length=128))

        # Changing field 'MetadataScientificPropertyCustomizer.verbose_name'
        db.alter_column(u'questionnaire_metadatascientificpropertycustomizer', 'verbose_name', self.gf('django.db.models.fields.CharField')(max_length=128))

    def backwards(self, orm):

        # Changing field 'MetadataStandardPropertyCustomizer.default_value'
        db.alter_column(u'questionnaire_metadatastandardpropertycustomizer', 'default_value', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

        # Changing field 'MetadataStandardPropertyCustomizer.field_type'
        db.alter_column(u'questionnaire_metadatastandardpropertycustomizer', 'field_type', self.gf('django.db.models.fields.CharField')(max_length=64))

        # Changing field 'MetadataStandardPropertyCustomizer.verbose_name'
        db.alter_column(u'questionnaire_metadatastandardpropertycustomizer', 'verbose_name', self.gf('django.db.models.fields.CharField')(max_length=64))

        # Changing field 'MetadataScientificPropertyCustomizer.default_value'
        db.alter_column(u'questionnaire_metadatascientificpropertycustomizer', 'default_value', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

        # Changing field 'MetadataScientificPropertyCustomizer.field_type'
        db.alter_column(u'questionnaire_metadatascientificpropertycustomizer', 'field_type', self.gf('django.db.models.fields.CharField')(max_length=64))

        # Changing field 'MetadataScientificPropertyCustomizer.verbose_name'
        db.alter_column(u'questionnaire_metadatascientificpropertycustomizer', 'verbose_name', self.gf('django.db.models.fields.CharField')(max_length=64))
