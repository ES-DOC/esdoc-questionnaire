...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MetadataScientificPropertyCustomizer.category'
        db.alter_column(u'questionnaire_metadatascientificpropertycustomizer', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['questionnaire.MetadataScientificCategoryCustomizer']))

    def backwards(self, orm):

        # Changing field 'MetadataScientificPropertyCustomizer.category'
        db.alter_column(u'questionnaire_metadatascientificpropertycustomizer', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['questionnaire.MetadataScientificCategoryCustomizer']))
