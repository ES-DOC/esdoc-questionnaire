...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MetadataSite.site'
        db.alter_column(u'questionnaire_metadatasite', 'site_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['sites.Site']))

    def backwards(self, orm):

        # Changing field 'MetadataSite.site'
        db.alter_column(u'questionnaire_metadatasite', 'site_id', self.gf('django.db.models.fields.related.OneToOneField')(default=None, unique=True, to=orm['sites.Site']))
