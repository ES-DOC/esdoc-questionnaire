...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'MetadataStandardProperty.relationship_value'
        db.delete_column(u'questionnaire_metadatastandardproperty', 'relationship_value_id')

        # Adding M2M table for field relationship_value on 'MetadataStandardProperty'
        m2m_table_name = db.shorten_name(u'questionnaire_metadatastandardproperty_relationship_value')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('metadatastandardproperty', models.ForeignKey(orm['questionnaire.metadatastandardproperty'], null=False)),
            ('metadatamodel', models.ForeignKey(orm['questionnaire.metadatamodel'], null=False))
        ))
        db.create_unique(m2m_table_name, ['metadatastandardproperty_id', 'metadatamodel_id'])


    def backwards(self, orm):
        # Adding field 'MetadataStandardProperty.relationship_value'
        db.add_column(u'questionnaire_metadatastandardproperty', 'relationship_value',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['questionnaire.MetadataModel'], null=True, blank=True),
                      keep_default=False)

        # Removing M2M table for field relationship_value on 'MetadataStandardProperty'
        db.delete_table(db.shorten_name(u'questionnaire_metadatastandardproperty_relationship_value'))
