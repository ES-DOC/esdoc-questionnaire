...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MetadataModel.last_modified'
        db.add_column(u'questionnaire_metadatamodel', 'last_modified',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MetadataModel.is_published'
        db.add_column(u'questionnaire_metadatamodel', 'is_published',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'MetadataModel.is_published'
        db.delete_column(u'questionnaire_metadatamodel', 'is_published')
