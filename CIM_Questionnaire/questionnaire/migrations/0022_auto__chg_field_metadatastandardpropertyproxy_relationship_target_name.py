...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MetadataStandardPropertyProxy.relationship_target_name'
        db.alter_column(u'questionnaire_metadatastandardpropertyproxy', 'relationship_target_name', self.gf('django.db.models.fields.CharField')(max_length=512, null=True))

    def backwards(self, orm):

        # Changing field 'MetadataStandardPropertyProxy.relationship_target_name'
        db.alter_column(u'questionnaire_metadatastandardpropertyproxy', 'relationship_target_name', self.gf('django.db.models.fields.CharField')(default='', max_length=512))
