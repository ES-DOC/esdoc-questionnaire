...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'MetadataStandardCategoryCustomizer.pending_deletion'
        db.delete_column(u'questionnaire_metadatastandardcategorycustomizer', 'pending_deletion')

        # Deleting field 'MetadataScientificCategoryCustomizer.pending_deletion'
        db.delete_column(u'questionnaire_metadatascientificcategorycustomizer', 'pending_deletion')


    def backwards(self, orm):
        # Adding field 'MetadataStandardCategoryCustomizer.pending_deletion'
        db.add_column(u'questionnaire_metadatastandardcategorycustomizer', 'pending_deletion',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'MetadataScientificCategoryCustomizer.pending_deletion'
        db.add_column(u'questionnaire_metadatascientificcategorycustomizer', 'pending_deletion',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
    ...
    models = {
        ...
        'questionnaire.metadatamodelcustomizer': {
            ...
            'sorted_vocabularies': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'model_customizer'", 'to': "orm['questionnaire.MetadataVocabulary']", 'through': "orm['questionnaire.MetadataModelCustomizerVocabulary']", 'blank': 'True', 'symmetrical': 'False', 'null': 'True'}),
        ...
        'questionnaire.metadatamodelcustomizervocabulary': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'model_customizer': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'link_to_model_customizer'", 'to': "orm['questionnaire.MetadataModelCustomizer']"}),
            'order': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'vocabulary': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'link_to_vocabulary'", 'to': "orm['questionnaire.MetadataVocabulary']"}),
            'vocabulary_key': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True'})
        },
        ...
        'questionnaire.metadatascientificpropertycustomizer': {
            ...
            'category': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'scientific_property_customizers'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': "orm['questionnaire.MetadataScientificCategoryCustomizer']"}),
        ...
        'questionnaire.metadatastandardcategorycustomizer': {
            'Meta': {'ordering': "['order']", 'unique_together': "(('key', 'project', 'proxy', 'model_customizer'),)", 'object_name': 'MetadataStandardCategoryCustomizer'},
            'created': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'max_length': '512', 'null': 'True', 'blank': 'True'}),
        ...
        'questionnaire.metadatastandardpropertycustomizer': {
            ...
            'atomic_type': ('django.db.models.fields.CharField', [], {'default': "'DEFAULT'", 'max_length': '512', 'blank': 'True'}),
            'category': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'standard_property_customizers'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': "orm['questionnaire.MetadataStandardCategoryCustomizer']"}),
            'category_name': ('django.db.models.fields.CharField', [], {'max_length': '512', 'null': 'True', 'blank': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'default_value': ('django.db.models.fields.CharField', [], {'max_length': '512', 'null': 'True', 'blank': 'True'}),
            'displayed': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
