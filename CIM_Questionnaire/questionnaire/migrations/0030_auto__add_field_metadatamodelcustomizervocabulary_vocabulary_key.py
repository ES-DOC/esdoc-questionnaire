...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MetadataModelCustomizerVocabulary.vocabulary_key'
        db.add_column(u'questionnaire_metadatamodelcustomizervocabulary', 'vocabulary_key',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True),
                      keep_default=False)
        # MODIFIED BY AT
        # adding vocabulary keys to existing metdatamodelcustomizervocabulary models
        ...
        for metadata_model_customizer_vocabulary in MetadataModelCustomizerVocabularyClass.objects.all():
            vocabulary = metadata_model_customizer_vocabulary.vocabulary
            metadata_model_customizer_vocabulary.vocabulary_key = vocabulary.get_key()
            metadata_model_customizer_vocabulary.save()
        # END MODIFIED BY AT

    def backwards(self, orm):
        # Deleting field 'MetadataModelCustomizerVocabulary.vocabulary_key'
        db.delete_column(u'questionnaire_metadatamodelcustomizervocabulary', 'vocabulary_key')
