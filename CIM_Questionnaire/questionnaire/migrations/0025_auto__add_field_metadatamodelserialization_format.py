...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MetadataModelSerialization.format'
        db.add_column(u'questionnaire_metadatamodelserialization', 'format',
                      self.gf('django.db.models.fields.CharField')(default='ESDOC_XML', max_length=256),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MetadataModelSerialization.format'
        db.delete_column(u'questionnaire_metadatamodelserialization', 'format')
