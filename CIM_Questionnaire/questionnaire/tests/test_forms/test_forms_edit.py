...
class Test(TestQuestionnaireBase):
    ...
    def test_create_model_form_data(self):
        ...
        test_models_data = [
            {'is_root': True,  'version': self.version.pk, 'created': None, 'component_key': DEFAULT_COMPONENT_KEY,                                                                                           'description': u'A ModelCompnent is nice.', 'title': u'RootComponent',                        'order': 0, 'project': self.project.pk, 'proxy': test_proxy.pk, 'vocabulary_key': DEFAULT_VOCABULARY_KEY,    'is_document': True, 'active': True, u'id': None, 'name': u'modelComponent', "is_published" : False, },
            {'is_root': False, 'version': self.version.pk, 'created': None, 'component_key': MetadataComponentProxy.objects.get(vocabulary=test_vocabulary, name__iexact="testmodel").get_key(),              'description': u'A ModelCompnent is nice.', 'title': u'vocabulary : TestModel',               'order': 0, 'project': self.project.pk, 'proxy': test_proxy.pk, 'vocabulary_key': test_vocabulary.get_key(), 'is_document': True, 'active': True, u'id': None, 'name': u'modelComponent', "is_published" : False, },
            {'is_root': False, 'version': self.version.pk, 'created': None, 'component_key': MetadataComponentProxy.objects.get(vocabulary=test_vocabulary, name__iexact="testmodelkeyproperties").get_key(), 'description': u'A ModelCompnent is nice.', 'title': u'vocabulary : TestModelKeyProperties',  'order': 0, 'project': self.project.pk, 'proxy': test_proxy.pk, 'vocabulary_key': test_vocabulary.get_key(), 'is_document': True, 'active': True, u'id': None, 'name': u'modelComponent', "is_published" : False, },
            {'is_root': False, 'version': self.version.pk, 'created': None, 'component_key': MetadataComponentProxy.objects.get(vocabulary=test_vocabulary, name__iexact="pretendsubmodel").get_key(),        'description': u'A ModelCompnent is nice.', 'title': u'vocabulary : PretendSubModel',         'order': 0, 'project': self.project.pk, 'proxy': test_proxy.pk, 'vocabulary_key': test_vocabulary.get_key(), 'is_document': True, 'active': True, u'id': None, 'name': u'modelComponent', "is_published" : False, },
            {'is_root': False, 'version': self.version.pk, 'created': None, 'component_key': MetadataComponentProxy.objects.get(vocabulary=test_vocabulary, name__iexact="submodel").get_key(),               'description': u'A ModelCompnent is nice.', 'title': u'vocabulary : SubModel',                'order': 0, 'project': self.project.pk, 'proxy': test_proxy.pk, 'vocabulary_key': test_vocabulary.get_key(), 'is_document': True, 'active': True, u'id': None, 'name': u'modelComponent', "is_published" : False, },
            {'is_root': False, 'version': self.version.pk, 'created': None, 'component_key': MetadataComponentProxy.objects.get(vocabulary=test_vocabulary, name__iexact="subsubmodel").get_key(),            'description': u'A ModelCompnent is nice.', 'title': u'vocabulary : SubSubModel',             'order': 0, 'project': self.project.pk, 'proxy': test_proxy.pk, 'vocabulary_key': test_vocabulary.get_key(), 'is_document': True, 'active': True, u'id': None, 'name': u'modelComponent', "is_published" : False, },
        ]
    ...
    def test_create_scientific_property_form_data(self):
        ...
        test_scientific_property_form_data = {
            ...
            u'%s_%s' % (test_vocabulary.get_key(), MetadataComponentProxy.objects.get(vocabulary=test_vocabulary, name__iexact="pretendsubmodel").get_key()) : [
                {'field_type': 'PROPERTY', 'enumeration_other_value': 'Please enter a custom value', 'extra_description': None, 'name': u'name',    'category_key': u'categoryone',         'is_enumeration': False,    'extra_standard_name': None, u'id': None, 'enumeration_value': None, 'proxy': MetadataScientificPropertyProxy.objects.get(component__name__iexact="pretendsubmodel",category__key="categoryone",name="name").pk, 'is_label': False, 'extra_units': None, 'order': 0, 'atomic_value': None}
            ],
            ...
            u'%s_%s' % (test_vocabulary.get_key(), MetadataComponentProxy.objects.get(vocabulary=test_vocabulary, name__iexact="subsubmodel").get_key()) : [
                {'field_type': 'PROPERTY', 'enumeration_other_value': 'Please enter a custom value', 'extra_description': None, 'name': u'name',    'category_key': u'categoryone',         'is_enumeration': False,    'extra_standard_name': None, u'id': None, 'enumeration_value': None, 'proxy': MetadataScientificPropertyProxy.objects.get(component__name__iexact="subsubmodel",category__key="categoryone",name="name").pk, 'is_label': False, 'extra_units': None, 'order': 0, 'atomic_value': None}
            ],
