...
"""
.. module:: test_metadata_authentication

Tests the MetadataUser models
"""
...
class TestMetadataUser(TestQuestionnaireBase):
    ...
    def test_join_project(self):
        ...
        test_project = self.downscaling_project

        self.assertEqual(len(test_user.projects.all()), 0)
        self.assertFalse(test_user.is_member_of(test_project))
        self.assertFalse(test_user.is_user_of(test_project))
        self.assertFalse(test_user.is_admin_of(test_project))

        test_user.join_project(test_project)

        self.assertEqual(len(test_user.projects.all()), 1)
        self.assertTrue(test_user.is_member_of(test_project))
        self.assertFalse(test_user.is_user_of(test_project))
        self.assertFalse(test_user.is_admin_of(test_project))
    ...
    def test_add_group(self):
        ...
        self.assertTrue(test_user.is_member_of(test_project))
        self.assertTrue(test_user.is_user_of(test_project))
        self.assertTrue(test_user.is_admin_of(test_project))
