...
class TestMetadataVocabulary(TestQuestionnaireBase):
    ...
    def test_register(self):
        ...
        test_components_data = [
            {'vocabulary': test_vocabulary.pk, 'documentation': None, 'order': 1, 'name': u'TestModel'},
            {'vocabulary': test_vocabulary.pk, 'documentation': None, 'order': 2, 'name': u'TestModelKeyProperties'},
            {'vocabulary': test_vocabulary.pk, 'documentation': None, 'order': 3, 'name': u'PretendSubModel'},
            {'vocabulary': test_vocabulary.pk, 'documentation': None, 'order': 4, 'name': u'SubModel'},
            {'vocabulary': test_vocabulary.pk, 'documentation': None, 'order': 5, 'name': u'SubSubModel'},
        ]
        ...
        test_categories_data = [
            {'name': u'General Attributes', 'component': component_testmodelkeyproperties.pk,   'key': u'general-attributes',   'order': 0, 'description': None},
            {'name': u'General Attributes', 'component': component_submodel.pk,                 'key': u'general-attributes',   'order': 0, 'description': None},
            {'name': u'General Attributes', 'component': component_testmodel.pk,                'key': u'general-attributes',   'order': 0, 'description': None},
            {'name': u'General Attributes', 'component': component_subsubmodel.pk,              'key': u'general-attributes',   'order': 0, 'description': None},
            {'name': u'General Attributes', 'component': component_pretendsubmodel.pk,          'key': u'general-attributes',   'order': 0, 'description': None},
            {'name': u'CategoryOne',        'component': component_subsubmodel.pk,              'key': u'categoryone',          'order': 1, 'description': None},
            {'name': u'CategoryOne',        'component': component_testmodelkeyproperties.pk,   'key': u'categoryone',          'order': 1, 'description': None},
            {'name': u'CategoryOne',        'component': component_pretendsubmodel.pk,          'key': u'categoryone',          'order': 1, 'description': None},
            {'name': u'CategoryOne',        'component': component_submodel.pk,                 'key': u'categoryone',          'order': 1, 'description': None},
            {'name': u'CategoryTwo',        'component': component_testmodelkeyproperties.pk,   'key': u'categorytwo',          'order': 2, 'description': None},
        ]
        ...
        for actual_category_data, test_category_data in zip(categories_data, test_categories_data):
            try:
                self.assertDictEqual(actual_category_data, test_category_data, excluded_keys=["id", "last_modified", "created",])
            except:
