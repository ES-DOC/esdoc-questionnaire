...
from Q.questionnaire.q_fields_bak import MetadataFieldTypes, MetadataAtomicFieldTypes
...
from Q.questionnaire.models.models_realizations_bak import MetadataModel, MetadataScientificProperty
from Q.questionnaire.models.models_proxies import QScientificPropertyProxy as MetadataScientificPropertyProxy
from Q.questionnaire.q_utils import find_in_sequence, update_field_widget_attributes, set_field_widget_attributes
...
class MetadataScientificPropertyForm(MetadataEditingForm):
    ...
    class Meta:
        ...
        fields = [
            # hidden fields...
            "proxy", "field_type", "name", "order", "is_label", "id", "category_key", "is_enumeration",
            # value fields...
            "atomic_value", "enumeration_value", "enumeration_other_value",
            "extra_standard_name", "extra_description", "extra_units",
        ]
