...
from Q.questionnaire.forms.bak.forms_base_bak import MetadataForm, MetadataFormSet, MetadataInlineFormSet, remove_non_loaded_data, remove_null_data, get_data_from_formset
from Q.questionnaire.models.models_realizations_bak import MetadataModel
from Q.questionnaire.q_fields_bak import MetadataFieldTypes
...
def create_new_edit_forms_from_models(models, model_customizer, standard_properties, standard_property_customizers, scientific_properties,scientific_property_customizers, inheritance_data=None):
    ...
    from .forms_edit_model_bak import create_model_form_data, MetadataModelFormSetFactory
...
def create_existing_edit_forms_from_models(models, model_customizer, standard_properties, standard_property_customizers, scientific_properties, scientific_property_customizers, inheritance_data=None):
    ...
    from .forms_edit_model_bak import MetadataModelFormSetFactory
    from .forms_edit_standard_properties_bak import MetadataStandardPropertyInlineFormSetFactory
    from .forms_edit_scientific_properties_bak import MetadataScientificPropertyInlineFormSetFactory
...
def create_existing_edit_subforms_from_models(models, model_customizer, standard_properties, standard_property_customizers, scientific_properties, scientific_property_customizers, subform_prefix="", subform_min=0, subform_max=1, increment_prefix=0, inheritance_data=None):
    ...
    from .forms_edit_model_bak import MetadataModelSubFormSetFactory
    from .forms_edit_standard_properties_bak import MetadataStandardPropertyInlineSubFormSetFactory
    from .forms_edit_scientific_properties_bak import MetadataScientificPropertyInlineFormSetFactory
...
def create_edit_subforms_from_data(data, models, model_customizer, standard_properties, standard_property_customizers, scientific_properties, scientific_property_customizers, subform_prefix="", subform_min=0, subform_max=1, inheritance_data=None):
    ...
    from .forms_edit_model_bak import create_model_form_data, MetadataModelSubFormSetFactory
    from .forms_edit_standard_properties_bak import create_standard_property_form_data, MetadataStandardPropertyInlineSubFormSetFactory
    from .forms_edit_scientific_properties_bak import create_scientific_property_form_data, MetadataScientificPropertyInlineFormSetFactory
...
def save_valid_forms(model_formset, standard_properties_formsets, scientific_properties_formsets, model_parent_dictionary={}):
    ...
    from .forms_edit_model_bak import save_valid_model_formset
    from .forms_edit_standard_properties_bak import save_valid_standard_properties_formset
    from .forms_edit_scientific_properties_bak import save_valid_scientific_properties_formset

    model_instances = save_valid_model_formset(model_formset, model_parent_dictionary=model_parent_dictionary)

    for model_instance in model_instances:
        model_key = model_instance.get_model_key()
        standard_property_instances = save_valid_standard_properties_formset(standard_properties_formsets[model_key])
        ...
        scientific_property_instances = save_valid_scientific_properties_formset(scientific_properties_formsets[model_key])
        for scientific_property_instance in scientific_property_instances:
            scientific_property_instance.model = model_instance
