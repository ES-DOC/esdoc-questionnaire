...
# class QModelForm(NgFormValidationMixin, NgModelForm):
    ...
    def get_widget_attrs(self, bound_field):
        ...
        # I make sure to set the "widget_css_classes" when calling set_widget_attributes or update_widget_attributes
    ...
    # DON'T FORGET I CAN USE get_initial_data(self)
    # LIKE THIS: ``ng-init={{ my_form_name.get_initial_data|js|safe }}``
...
##########
# originally, a lot of effort was spent getting Djangular Forms to work in FormSets
# however, with the new load-on-demand paradigm, I only ever create a single form at a time
# in addition, most of the views save data using REST as opposed to standard Django form/formset processing
# so I don't actually ever need this code nor the FormSetFactories in other modules
# still, it's good code and I keep it here in-case things ever change
##########
