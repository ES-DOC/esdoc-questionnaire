    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_legacy', models.BooleanField(default=False, help_text=b"A legacy project is one that still uses CIM1;  If a legacy host is specified, then requests get routed there.  Do not check this unless you really know what you're doing.")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_required', models.BooleanField(default=True, help_text='All required properties must be completed prior to publication.  A property that is defined as required <em>in the CIM</em> cannot be made optional.', verbose_name=b'Is this property required?')),
                ...
                ('is_editable', models.BooleanField(default=True, help_text='If this field is disabled, this is because a default value was set by the CIM itself and should not therefore be overridden by the ES-DOC Questionnaire.', verbose_name=b'Can this property be edited?')),
                ('is_nillable', models.BooleanField(default=True, help_text=b"A nillable property can be intentionally left blank for several reasons: Unknown, Missing, Inapplicable, Template, Withheld.  In general, relationship properties needn't be made nillable, since the relationships can simply be removed.", verbose_name=b'Should <i>nillable</i> options be allowed?')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('institute', models.ForeignKey(blank=True, to='questionnaire.QInstitute', help_text='Please select the institute for which you intend to publish documents.  If no selection is made, you will be unable to publish.', null=True)),
