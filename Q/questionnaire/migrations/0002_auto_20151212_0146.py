...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            model_name='qproject',
            name='is_displayed',
            field=models.BooleanField(default=True, help_text=b'A project that is not displayed is not included in the Index Page, although users can still navigate to it if they know its URL'),
        ),
