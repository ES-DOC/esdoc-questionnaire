...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('questionnaire', '0002_auto_20170516_1457'),
    ]

    operations = [
        migrations.AddField(
            model_name='qpropertycustomization',
            name='enumeration_display_all',
            field=models.BooleanField(default=False, verbose_name=b'Should this enumeration be open by default?'),
        ),
