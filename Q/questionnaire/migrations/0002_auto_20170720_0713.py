...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            model_name='qproject',
            name='order',
            field=models.PositiveIntegerField(default=0, help_text='What order should this project be presented in the index page?', validators=[Q.questionnaire.models.models_projects.validate_in_project_range]),
        ...
        migrations.AlterField(
            ...
            name='cim_id',
            field=models.CharField(null=True, validators=[Q.questionnaire.q_utils.ValidateNoSpaces()], max_length=256, blank=True, help_text='A unique, CIM-specific, identifier.  This is distinct from the automatically-generated key.  It is required for distinguishing specialized objects of the same class.', unique=True),
        ),
        migrations.AlterField(
