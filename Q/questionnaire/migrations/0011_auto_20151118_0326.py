...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('questionnaire', '0010_auto_20151118_0051'),
    ]

    operations = [
        migrations.AlterModelOptions(
            name='qscientificcategorycustomization',
            options={'ordering': ['order'], 'verbose_name': 'Questionnaire Scientific Category Customization', 'verbose_name_plural': '_Questionnaire Customizations: Scientific Categories'},
        ),
        migrations.AlterModelOptions(
            name='qstandardcategorycustomization',
            options={'ordering': ['order'], 'verbose_name': 'Questionnaire Standard Category Customization', 'verbose_name_plural': '_Questionnaire Customizations: Standard Categories'},
        ),
