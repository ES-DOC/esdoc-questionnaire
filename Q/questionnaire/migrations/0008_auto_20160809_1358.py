...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('questionnaire', '0007_auto_20160804_1014'),
    ]

    operations = [
        migrations.AlterModelOptions(
            name='qpropertycustomization',
            options={'verbose_name': '_Questionnaire Property Customization', 'verbose_name_plural': '_Questionnaire Property Customization'},
        ),
