...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='qmodelcustomization',
            name='vocabularies',
            field=models.ManyToManyField(related_name='model_customizer', verbose_name=b'Vocabularies to include', to='questionnaire.QVocabulary', through='questionnaire.QModelCustomizationVocabulary', blank=True),
        ),
        migrations.AlterField(
