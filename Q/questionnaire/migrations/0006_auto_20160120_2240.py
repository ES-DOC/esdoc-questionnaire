...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('questionnaire', '0005_auto_20160109_1554'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='file',
            field=Q.questionnaire.q_fields.QFileField(help_text=b'Note that files with the same names will be overwritten', storage=Q.questionnaire.q_fields.OverwriteStorage(), upload_to=b'questionnaire/ontologies'),
        ),
        migrations.AlterField(
            model_name='qontology',
            name='name',
