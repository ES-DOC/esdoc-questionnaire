...
class TestQVocabulary(TestQBase):
    ...
    def test_vocabulary_register(self):
        ...
        actual_component_proxies_data = [
            serialize_model_to_dict(component_proxy, exclude=["id", "guid", "created", "modified", ] + MPTT_FIELDS)
            for component_proxy in test_component_proxies
        ]

        test_component_proxies_data = [
        ...
        for actual_compnent_proxy_data, test_component_proxy_data in zip(actual_component_proxies_data, test_component_proxies_data):
            self.assertDictEqual(actual_compnent_proxy_data, test_component_proxy_data)
        ...
        test_category_proxies_data = [
            {'documentation': None, 'component_proxy': test_component_proxies[0].pk, 'name': u'General Attributes', 'key': u'general-attributes', 'order': 0},
            {'documentation': None, 'component_proxy': test_component_proxies[1].pk, 'name': u'General Attributes', 'key': u'general-attributes', 'order': 0},
            {'documentation': None, 'component_proxy': test_component_proxies[1].pk, 'name': u'CategoryOne', 'key': u'categoryone', 'order': 1},
            {'documentation': None, 'component_proxy': test_component_proxies[1].pk, 'name': u'CategoryTwo', 'key': u'categorytwo', 'order': 2},
            {'documentation': None, 'component_proxy': test_component_proxies[2].pk, 'name': u'General Attributes', 'key': u'general-attributes', 'order': 0},
            {'documentation': None, 'component_proxy': test_component_proxies[2].pk, 'name': u'CategoryOne', 'key': u'categoryone', 'order': 1},
            {'documentation': None, 'component_proxy': test_component_proxies[3].pk, 'name': u'General Attributes', 'key': u'general-attributes', 'order': 0},
            {'documentation': None, 'component_proxy': test_component_proxies[3].pk, 'name': u'CategoryOne', 'key': u'categoryone', 'order': 1},
            {'documentation': None, 'component_proxy': test_component_proxies[4].pk, 'name': u'General Attributes', 'key': u'general-attributes', 'order': 0},
            {'documentation': None, 'component_proxy': test_component_proxies[4].pk, 'name': u'CategoryOne', 'key': u'categoryone', 'order': 1},
        ]
        ...
        test_property_proxies_data = [
            {'category': test_category_proxies[1].pk, 'field_type': u'ATOMIC', 'atomic_default': None, 'enumeration_nullable': False, 'name': u'name', 'enumeration_multi': False, 'choice': u'keyboard', 'documentation': u'I am free text.', 'atomic_type': u'DEFAULT', 'component_proxy': test_component_proxies[1].pk, 'enumeration_open': False, 'enumeration_choices': u'', 'cardinality': u'0|1', 'order': 0},
