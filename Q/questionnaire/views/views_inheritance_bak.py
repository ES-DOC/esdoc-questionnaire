...
from Q.questionnaire.views.views_base import get_key_from_request
from Q.questionnaire.q_utils import QError


# TODO: DOUBLE-CHECK THAT THIS STILL WORKS W/ ACTUAL CACHES
# TODO: INSTEAD OF SESSIONS
...
def api_add_inheritance_data(request, **kwargs):
    ...
    if request.method != "POST":
        raise QError("api_add_inheritance_data can only accept POST requests")
