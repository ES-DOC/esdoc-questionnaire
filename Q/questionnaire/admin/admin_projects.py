...
class QProjectVocabularyInline(admin.TabularInline):
    model = QProjectVocabulary
    extra = 1

class QrojectAdmin(admin.ModelAdmin):
    """
    Custom ModelAdmin for QProjects
    Provides an inline form for adding QProjectVocabularies
    """
    inlines = (QProjectVocabularyInline,)
