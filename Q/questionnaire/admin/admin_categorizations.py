...
from Q.questionnaire.models.models_proxies import QCategoryProxy
...
class QCategorizationAdminForm(ModelForm):
    ...
    category_proxies = ModelMultipleChoiceField(label="QCategories", required=False, queryset=QCategoryProxy.objects.none())
