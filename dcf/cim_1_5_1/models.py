...
MetadataVersion.factory({"name":"CIM","version":"1.5.1"})
...
class SoftwareComponent(MetadataModel):
    ...
    responsibleParties  = MetadataManyToManyField(targetModel='cim_1_5_1.ResponsibleParty',sourceModel="cim_1_5_1.SoftwareComponent")
