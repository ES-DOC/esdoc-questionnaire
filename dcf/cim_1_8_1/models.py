...
MetadataVersion.factory({"name":"CIM","version":"1.8.1"})
...
class SoftwareComponent(MetadataModel):
    ...
    responsibleParties  = MetadataManyToManyField(targetModel='cim_1_8_1.ResponsibleParty',sourceModel="cim_1_8_1.SoftwareComponent")
...
class StatisticalModelComponent(SoftwareComponent):
    ...
    _description = "A StatisticalModelComponent it represents a statistical downscaling method."
